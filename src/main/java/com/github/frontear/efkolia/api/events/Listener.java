...
/**
 * An interface which defines a method that is only meant to run when fired through an
 * {@link IEventExecutor}.
 */
...
public @interface Listener {
     ...
     * directly affect the order of the invocations listeners execute in via
     * {@link IEventExecutor#fire(Object)}.
     *

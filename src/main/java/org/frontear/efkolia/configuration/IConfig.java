 ...
 * information from files and parse them into objects, specifically {@link }. It must register the
 * objects that require modification, and modify them whenever the config file is loaded.
 */
public interface IConfig {
     ...
     */
    void register(@NotNull final Object object);
     ...
     * @param object The object to register to the configuration
     */
    void unregister(@NotNull final Object object);

    /**
     * Attempts to read the configuration file into the program, then iterate on all {@link
     * IConfig#register(Object)} elements to modify their internal state.
     */
    void load();

    /**
     * Saves the internal state of all {@link IConfig#register(Object)} elements to the
     * configuration file.
     */
    void save();
}
